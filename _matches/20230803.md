...
keywords: NDAA, norwich & district anglers, norwich and district angling, norwich & district, matches, fishing match, match list, match calendar, match listing, pairs series round 4, pairs round 4
---
                    ...
                    <table class="match-result">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td--right{% if row.R3-W-Lowest == "Y" %} td--lowest{% endif %}" data-heading="R4 Weight">{{ row.R4-W }}</td>
